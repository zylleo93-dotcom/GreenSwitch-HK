...
import { DollarSign, Leaf, Clock, Award, Info, LayoutDashboard, Eye } from 'lucide-react';
...
const Step4HEC = ({ 
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex bg-slate-100 p-1 rounded-xl self-start">
          <button 
            ...
            className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center space-x-2 transition-all ${
              viewMode === 'dashboard' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
      ...
      <ReportPreview data={reportData} utility="HEC" />
    )}
  </div>
);
};
