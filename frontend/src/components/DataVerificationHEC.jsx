...
const DataVerificationHEC = ({ data, onDataChange, onConfirm, globalFiles, onGlobalFileUpload }) => {
            ...
            <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col">
              ...
              <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-white sticky top-0 z-10">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1 font-medium">項目編號: <span className="text-emerald-600 font-bold">{items.find(i => i.id === editingRowId)?.projectId || '---'}</span></p>
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-8">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <label className="aspect-video border-2 border-dashed border-slate-200 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-emerald-400 hover:bg-emerald-50/30 transition-all group">
                      <input type="file" className="hidden" multiple onChange={(e) => handleDeviceFileUpload(editingRowId, e.target.files)} />
                      ...
                      <span className="text-[10px] font-bold text-slate-400 mt-2 group-hover:text-emerald-600">上傳此設備文件</span>
                    </label>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      { label: '新設備能源標籤', count: globalFiles.efficiency.length, color: 'bg-emerald-50 text-emerald-600' },
                      { label: '舊設備能源標籤', count: globalFiles.oldEfficiency.length, color: 'bg-amber-50 text-amber-600' },
